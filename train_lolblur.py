...
if __name__ == '__main__':
    model_test = ReDUNet().cuda()
    macs, params = get_model_complexity_info(model_test, (3, 256, 256), as_strings=True, print_per_layer_stat=False, verbose=False)
    print("macs {}, params {}".format(macs, params))
    
    root_path = '/home/data/dupf/ddd'
