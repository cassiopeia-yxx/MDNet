...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str, default='datasets/VV')
    ...
    img_paths = sorted(list(scandir(args.test_path, suffix=('jpg', 'png', 'bmp','JPG'), recursive=True, full_path=True)))
